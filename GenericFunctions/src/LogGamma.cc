...
const CLHEPdouble LogGamma::_coefficient[6]={
  +76.18009172947146,
  -86.50532032941677,
  +24.01409824083091,
  -1.231739572450155,
...
CLHEPdouble LogGamma::operator() (CLHEPdouble x) const {
  CLHEPdouble y=x,tmp=x+5.5,ser=1.000000000190015,c=2.5066282746310005;
  tmp -= (x+0.5)*log(tmp);
