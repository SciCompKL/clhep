...
// flatArray() return CLHEPdouble random values ranging between ]0,1[.
...
public:
  ...
  virtual CLHEPdouble flat() = 0;
  // Should return a pseudo random number between 0 and 1 
  // (excluding the end points)

  virtual void flatArray(const int size, CLHEPdouble* vect) = 0;
  ...
  virtual operator CLHEPdouble();        // Returns same as flat()
  virtual operator CLHEPfloat();         // less precise flat, faster if possible
  ...
  // random number as either a CLHEPdouble-precision CLHEPfloat, a single-precision
  // CLHEPfloat, or a 32-bit unsigned integer. The usage, presuming an object
...
protected:
  ...
  static  inline CLHEPdouble exponent_bit_32();
  static  inline CLHEPdouble mantissa_bit_12();
  static  inline CLHEPdouble mantissa_bit_24();
  static  inline CLHEPdouble mantissa_bit_32();
  static  inline CLHEPdouble twoToMinus_32();
  static  inline CLHEPdouble twoToMinus_48();
  static  inline CLHEPdouble twoToMinus_49();
  static  inline CLHEPdouble twoToMinus_53();
  static  inline CLHEPdouble nearlyTwoToMinus_54();
