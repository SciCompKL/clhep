...
public:
  ...
  CLHEPdouble flat() override;
  // It returns a pseudo random number between 0 and 1,
  // excluding the end points.

  void flatArray(const int size, CLHEPdouble *vect) override;
  ...
  operator CLHEPdouble() override { return flat(); }
  operator CLHEPfloat() override { return CLHEPfloat(flat()); }
